...
Route::post('sendOTP', [App\Http\Controllers\api\auth\LoginController::class, 'sendOTP']);
Route::post('verifyOTP', [App\Http\Controllers\api\auth\LoginController::class, 'verifyOTP']);
Route::post('updateUser', [App\Http\Controllers\api\auth\LoginController::class, 'updateUser']);
