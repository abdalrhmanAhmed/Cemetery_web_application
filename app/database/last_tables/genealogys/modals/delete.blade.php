    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Delete Genealogy') }}</h6><button aria-label="Close" class="close"
                ...
                <form action="{{ route('gnealogy.destroy', $genealoge->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <input type="text" name="name" value="{{ $genealoge->name }}" class="form-control"
                                placeholder="إسم النسب" readonly>
                        </div>
                    </div>
