    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Delete Grave') }}</h6><button aria-label="Close" class="close"
            ...
            <form action="{{ route('ExcelShow.delete') }}" class="form" method="POST">
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-danger" type="submit" disabled
                        id="btn-delete">{{ __('Delete') }}</button>
