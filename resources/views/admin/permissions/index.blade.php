...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الصلاحيات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    الصلاحيات</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            <div class="pull-right">
                                @can('role-create')
                                    <a class="btn btn-primary btn-sm effect-scale" href="#modaldemo8" data-toggle="modal"
                                        data-effect="effect-scale">اضافة</a>
                                @endcan
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap table-hover " id="datatable">
                            <thead>
                                <tr>
                                    <th><input type="checkbox" name="chekckAll" id="select-all"
                            ...
                            <tbody>
                                @foreach ($permissions as $key => $permission)
                                    <tr>
                                        <td><input type="checkbox" value="{{ $permission->id }}" class="box1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">تعديل الصلاحية</h6><button aria-label="Close"
                                                ...
                                                <form action="{{ route('admin.permissions.update', $permission->id) }}"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button class="btn ripple btn-secondary btn-sm"
                                                            data-bs-dismiss="modal" type="button">إلغاء</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
        ...
        <div class="modal" id="deleteAll">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">حذف الصفوف المختارة</h6><button aria-label="Close" class="close"
                    ...
                    <form action="{{ route('admin.deleteAll') }}" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn ripple btn-secondary btn-sm" data-bs-dismiss="modal"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">إضافة صلاحية جديدة</h6><button aria-label="Close" class="close"
                            data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
