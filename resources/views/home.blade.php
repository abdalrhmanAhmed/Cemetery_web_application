...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-18 text-white">{{ __('Clients') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <p class="mb-3 tx-18 text-white">{{ __('Eemployees') }}</p>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="float-left my-auto mr-auto">
        ...
        <div class="col-md-12 col-lg-12 col-xl-7">
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    ...
                    <p class="tx-18 text-muted mb-0">Order Status and Tracking. Track your order from ship date to arrival.
        ...
        <div class="col-xl-4 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-18 mb-0 text-muted">A customer is an individual or business that purchases the goods
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-18 mb-0 text-muted">Sales activities are the tactics that salespeople use to achieve their
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <p class="tx-18 mb-0 text-muted">An order is an investor's instructions to a broker or brokerage firm
    ...
    <!-- row opened -->
    <div class="row row-sm row-deck"tets>
        <div class="col-md-12 col-lg-4 col-xl-4">
            <div class="card card-dashboard-eight pb-2">
                <h6 class="card-title">Your Top Countries</h6><span class="d-block mg-b-10 text-muted tx-18">Sales
