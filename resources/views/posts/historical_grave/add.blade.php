						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">إضافة قبر تاريخي</h4>
                                ...
                                <form action="{{route('historical_grave.store')}}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <input name="title" placeholder="عنوان القبر" class="form-control" type="text"  required>
                                            </input>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <input type="text" name="name_ar" placeholder="إسم صاحب القبر التاريخي" class="form-control" required>
                                        </div>
                                        <div class="col-md">
                                            <label for="name_en"> إسم صاحب القبر التاريخي إنجليزي</label>
                                            <input type="text" name="name_en" placeholder="إسم صاحب القبر التاريخي" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <textarea name="text" class="form-control ckeditor" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group row">
                                                    <div class="col-md map-input-with-no-padding">
                                                        ...
                                                        <input class="form-control" readonly name="latitude" type="text" required><br>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md">
                                                <div class="form-group row">
                                                    <div class="col-md map-input-with-no-padding">
                                                        ...
                                                        <input class="form-control" readonly  name="longitude" type="text" required><br>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
