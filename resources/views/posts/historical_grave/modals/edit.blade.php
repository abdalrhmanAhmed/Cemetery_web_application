                ...
                <form action="{{route('historical_grave.update', $historical_grave->id)}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <input type="text" name="name" value="{{$historical_grave->name}}" placeholder="إسم المقبرة" class="form-control" required>
                        </div>
                        {{-- <div class="col-md">
                    ...
                    <div class="row">
                        @php
                            $historical_graves = App\Models\HistoricalGrave::where('id', $historical_grave->id)->first();
                        @endphp
                        {{-- <div class="col-md">
                        ...
                        <div class="col-md">
                            <div class="form-group row">
                                <div class="col-md map-input-with-no-padding">
                                    <label>الرابط </label>
                                    <input class="form-control" value="{{$historical_grave->url}}"   name="url" type="text"><br>
                                </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-group row">
                                <div class="col-md map-input-with-no-padding">
                                    ...
                                    <input class="form-control" value="{{$historical_grave->icon}}"   name="icon" type="file"><br>
                                </div>
                            </div>
                        </div>
                    </div>
