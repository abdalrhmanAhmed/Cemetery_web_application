<!-- Basic modal -->
<div class="modal" id="delete{{$teaching->id}}">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <form action="{{route('teaching.destroy', $teaching->id)}}" method="POST">
                @csrf
                @method('DELETE')
                <div class="text-center">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <input type="text" name="name" value="{{$teaching->title}}" class="form-control" readonly>
                        </div>
                    </div>
