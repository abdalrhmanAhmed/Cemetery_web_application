                        ...
                        <div class="row mb-4">
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" name="ar"
                                    value="{{ $notification->getTranslation('title', 'ar') }}" required />
                            </div>
                            <div class="col-md">
                                <label for="">{{ __('Title In En') }}</label>
                                <input type="text" class="form-control" name="en"
                                    value="{{ $notification->getTranslation('title', 'en') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md">
                                <label for="">{{ __('Description') }} :</label>
                                <textarea class="form-control" name="description" required rows="10">{{ $notification->description }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
                            ...
                            <div class="col-md text-center">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img src='{{ URL::asset("public/notification-profile/$notification->image") }}'
                                            loading="lazy" alt="{{ $notification->name }}" width="170" height="170">
                                    </div>
                                </div>
                            </div>
                        </div>
