            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-primary" href="{{ route('ExcelShow.index') }}">
                            <i class="fa fa-eye"></i>
                            {{ __('Show') }}
                        </a>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">{{ __('Count Of Files') }}</th>
                                    <th class="wd-15p border-bottom-0">{{ __('Count Of Graves') }}</th>
                            ...
                            <tbody>
                                @foreach ($cemetery_sites as $cemetery_site)
                                        ...
                                        <td>
                                            <div class="main-img-user">
                                                <img alt="avatar" class="rounded-circle"
                                                    src='{{ URL::asset("public/cemetery_sites-profile/$cemetery_site->image") }}'
                                                    loading="lazy">
                                            </div>
                                        </td>
                                        <td>{{ $cemetery_site->name }}</td>
                                        <td>{!! Str::limit($cemetery_site->text, 10, ' ...') !!}
                                        <td>{{ App\Models\BurialExcel::where('cemetery_app_id', $cemetery_site->id)->distinct('file_name')->count() ?? 0 }}
                                        <td>{{ $cemetery_site->dead_total }}
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13" x-placement="bottom-start"
                                                    ...
                                                    <a style="color:#00b9ff"
                                                        href="{{ route('cemetery-site.show', $cemetery_site->id) }}"
                                                        class="dropdown-item">
                                                        <i class="fa fa-eye"></i>
                                                        {{ __('Show') }}
                                                    </a>
                                                    <a style="color: #555"
                                                        href="{{ route('uploadExcel.index', $cemetery_site->id) }}"
                                                        class="dropdown-item">
                                                        <i class="fa fa-plus"></i>
                                    ...
                                    @include('new.cemetery_sites.modals.files')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
...
@section('js')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ App\Models\Setting::where('key', 'google_key')->first()->value ?? '' }}&callback=initMap"
        async></script>
    <script>
