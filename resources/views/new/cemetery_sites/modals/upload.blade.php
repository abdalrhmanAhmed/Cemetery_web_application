    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                ...
                <br>
                <form action="{{ route('upload.cemetery-site',$cemetery_sites->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mg-t-10">
                                    ...
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox"><input  name="type" type="radio" value="3"> <span>{{ __('Voice') }}</span></label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox"><input  name="type" type="radio" value="2"> <span>{{ __('image') }}</span></label>
                                    </div>
                                </div>
                            </div>
                        </div>
