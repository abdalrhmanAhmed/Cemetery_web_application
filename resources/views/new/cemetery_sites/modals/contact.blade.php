    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Contacts') }}</h6><button aria-label="Close" class="close"
            ...
            <div class="modal-body">
                <div class="card">
                        ...
                        <form action='{{ route('contact.store', $cemetery_site->id) }}' method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <input type="text" name="value" placeholder='{{ __('Value') }}'
                                        class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        <button class="btn ripple btn-success" type="submit"><i class="fa fa-plus"></i>
                            {{ __('Add') }}</button>
