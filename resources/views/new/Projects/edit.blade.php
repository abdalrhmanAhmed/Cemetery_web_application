...
@section('content')
    ...
    <div class="row">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('ProjectsController.update', $libary->id) }}" method="post"
                            ...
                            <div class="col-md text-center">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img src='{{ URL::asset("public/Project-profile/$libary->image") }}' loading="lazy"
                                            alt="{{ $libary->name }}" width="170" height="170">
                                    </div>
                                </div>
                            </div>
                        </div>
