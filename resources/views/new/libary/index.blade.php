                            ...
                            @foreach ($libares as $libary)
                                <tr>
                                    ...
                                    <td>
                                        <div class="main-img-user">
                                            <img alt="avatar" class="rounded-circle"
                                                src='{{ URL::asset("public/libary-profile/$libary->image") }}'
                                                loading="lazy">
                                        </div>
                                    </td>
                                    <td>{{ $libary->name }}</td>
                                    <td>{{ App\Models\LibraryDetail::where('library_id', $libary->id)->count() ?? 0 }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{ route('show.libary', $libary->id) }}"
                                            style="color: #fff">
