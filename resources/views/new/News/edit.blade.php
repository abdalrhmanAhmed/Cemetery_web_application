    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a type="button" href="{{ route('NewsController.index') }}" class="btn btn-info btn-icon ms-2"
...
@section('content')
    ...
    <div class="row">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('NewsController.update', $libary->id) }}" method="post"
                            ...
                            <div class="col-md text-center">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img src='{{ URL::asset("public/News-profile/$libary->image") }}' loading="lazy"
