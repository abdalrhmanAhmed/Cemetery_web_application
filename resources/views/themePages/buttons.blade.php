...
@section('content')
            ...
            <div class="card" id="button1">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element1">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-primary btn-block">Primary</button>
	</div>
	<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
	...
	<div class="col-sm-6 col-md-3 mg-t-10">
		<button class="btn btn-dark btn-block">Dark</button>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element1"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card" id="button33">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code22" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code22" data-toggle="tab"
                                    href="#htms-code22" role="tab" aria-controls="htms-code22"
                                    aria-selected="true"><i class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element33">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-primary-gradient btn-block">Primary</button>
	</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>primary-gradient | secondary-gradient | success-gradient | warning-gradient |
                                    danger-gradient | info-gradient | light-gradient | dark-gradient</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="card" id="button2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element2">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-outline-primary btn-block">Primary</button>
	</div>
            ...
            <div class="card" id="button3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3"><button
                                        class="btn btn-indigo btn-rounded btn-block">Primary</button></div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0"><button
                                        class="btn btn-outline-indigo btn-rounded btn-block">Primary</button></div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0"><button
                                        class="btn btn-secondary btn-rounded btn-block">Secondary</button></div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0"><button
                                        class="btn btn-outline-secondary btn-rounded btn-block">Secondary</button></div>
                            </div>
                        </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element3">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-xs wd-xl-80p">
            ...
            <div class="card" id="button4">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3"><button class="btn btn-indigo btn-with-icon btn-block"><i
                                            class="typcn typcn-folder"></i> Folder</button></div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0"><button
                                        class="btn btn-primary btn-with-icon btn-block"><i class="typcn typcn-mail"></i>
                                        Mail</button></div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0"><button
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element4">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-xs wd-xl-80p">
            ...
            <div class="card" id="button5">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element5">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="btn-icon-list">
	<button class="btn btn-indigo btn-icon"><i class="typcn typcn-folder"></i></button>
            ...
            <div class="card" id="button6">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element6">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
            ...
            <div class="card" id="button7">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                            ...
                            <div class="row row-sm">
                                <div class="col-lg-4">
                                    <div aria-label="Basic example" class="btn-group" role="group">
                                        ...
                                        <button class="btn btn-secondary pd-x-25" type="button">Center</button> <button
                                            class="btn btn-secondary pd-x-25" type="button">Right</button>
                                    </div>
                                </div><!-- col-4 -->
                                    ...
                                    <div aria-label="Basic example" class="btn-group" role="group">
                                        <button class="btn btn-secondary btn-icon active" type="button"><i
                                            ...
                                            class="btn btn-secondary btn-icon" type="button"><i
                                                class="typcn typcn-media-pause-outline"></i></button> <button
                                            class="btn btn-secondary btn-icon" type="button"><i
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element7">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-sm">
	<div class="col-lg-4">
		<div aria-label="Basic example" class="btn-group" role="group">
