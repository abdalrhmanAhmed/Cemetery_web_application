...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Widgets</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    Widgets</span>
            </div>
        </div>
            ...
            <div class="card card-img-holder">
                <div class="card-body list-icons">
                    ...
                    <div class="card-footer p-0">
                        <p class="text-muted mb-0 pt-4"><i class="si si-arrow-down-circle text-warning mr-2"
        ...
        <div class="col-sm-12 col-lg-6 col-xl-3">
            <div class="card card-img-holder">
                <div class="card-body list-icons">
                    ...
                    <div class="card-footer p-0">
                        <p class="text-muted mb-0 pt-4"><i class="si si-arrow-up-circle text-success mr-2"></i>Less Sales
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-6 col-xl-3">
            <div class="card card-img-holder">
                <div class="card-body list-icons">
                    ...
                    <div class="card-footer p-0">
                        <p class="text-muted mb-0 pt-4"><i class="si si-check mr-1 text-primary mr-2"></i> Recent History
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <p class="tx-12 tx-gray-500 mb-3">On the other hand, we denounce with right indignation and dislike
                        imagesralized <a href="">Learn more</a></p>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="progress ht-20 mt-4">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary ht-20 w-50">50%
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="progress mt-4 ht-20">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning wd-60p ht-20">36%
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">20% Off</span><br>on buy
                                </h3>
                            ...
                            <div class="carousel-item flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">60% Off</span><br> on
                                    buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- Joseph Vaughan</i>
                                </div>
                            ...
                            <div class="carousel-item flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">90% Off</span><br> on
                                    buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- Alan Hemmings</i>
                                </div>
                    ...
                    <div id="myCarousel0" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">30% Off</span><br>on buy
                                </h3>
                                <div class="text-white m-t-20">
                                    <i>- Alan Hemmings</i>
                                </div>
                            ...
                            <div class="carousel-item flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">70% Off</span><br> on
                                    buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- Eric Lee</i>
                                </div>
                            ...
                            <div class="carousel-item flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">80% Off</span><br> on
                                    buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- Eric Lee</i>
                                </div>
            ...
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1 font-weight-bold">154<span class="text-success tx-13 ms-2">(+0.98%)</span>
                            </h4>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1 font-weight-bold">5274<span class="text-danger tx-13 ms-2">(-12.45%)</span>
                            </h4>
                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                        </div>
                    ...
                    <div class="progress progress-sm mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="70"
                            class="progress-bar bg-pink wd-50p" role="progressbar"></div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1   font-weight-bold">76.3%<span
                                    class="text-success tx-13 ms-2">(+13.52%)</span></h4>
                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                        </div>
                    ...
                    <div class="progress progress-sm mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="70"
                            class="progress-bar bg-teal wd-60p" role="progressbar"></div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1 font-weight-bold">5m 24s<span class="text-success tx-13 ms-2">(+19.5%)</span>
                            </h4>
                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                        </div>
                    ...
                    <div class="progress progress-sm mt-2">
                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="70"
                            class="progress-bar bg-purple wd-40p" role="progressbar"></div>
                    </div>
                ...
                <div class="card-body">
                    <div class="card-order">
                        ...
                        <h2 class="text-right "><i
                                class="mdi mdi-account-multiple icon-size float-left text-primary text-primary-shadow"></i><span>3,672</span>
                        </h2>
            ...
            <div class="card ">
                <div class="card-body">
                    <div class="card-widget">
                        ...
                        <h2 class="text-right"><i
                                class="mdi mdi-cube icon-size float-left text-success text-success-shadow"></i><span>$89,265</span>
                        </h2>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-widget">
                        ...
                        <h2 class="text-right"><i
                                class="icon-size mdi mdi-poll-box   float-left text-warning text-warning-shadow"></i><span>$23,987</span>
                        </h2>
            ...
            <div class="card ">
                <div class="card-body">
                    <div class="card-widget">
                        ...
                        <h2 class="text-right"><i
                                class="fa fa-cart-plus icon-size float-left text-danger text-danger-shadow"></i><span>46,486</span>
                        </h2>
        ...
        <div class="col-md-12 col-xl-4">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="wrapper w-100 mr-3">
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="mdi mdi-clock text-muted ms-1"></i>
                    ...
                    <div class="list d-flex align-items-center border-bottom py-3">
                        <div class="avatar brround d-block cover-image"
                            data-image-src="{{ URL::asset('assets/img/faces/1.jpg') }}">
                            <span class="avatar-status bg-green"></span>
                        </div>
                        <div class="wrapper w-100 mr-3">
                            <p class="mb-0">
                    ...
                    <div class="list d-flex align-items-center border-bottom py-3">
                        <div class="avatar brround d-block cover-image"
                            data-image-src="{{ URL::asset('assets/img/faces/14.jpg') }}">
                            <span class="avatar-status bg-green"></span>
                        </div>
                        <div class="wrapper w-100 mr-3">
                            <p class="mb-0">
                    ...
                    <div class="list d-flex align-items-center pt-3">
                        <div class="avatar brround d-block cover-image"
                            data-image-src="{{ URL::asset('assets/img/faces/4.jpg') }}">
                            <span class="avatar-status bg-green"></span>
                        </div>
                        <div class="wrapper w-100 mr-3">
                            <p class="mb-0">
                    ...
                    <div>
                        <div class="chips">
                            <div class="team">
                                <a href="javascript:void(0)" class="chip">
                                    <span class="avatar cover-image"
                                        data-image-src="{{ URL::asset('assets/img/faces/2.jpg') }}"></span> Victoria
                                </a>
                            ...
                            <div class="team">
                                <a href="javascript:void(0)" class="chip">
                                    <span class="avatar cover-image"
                                        data-image-src="{{ URL::asset('assets/img/faces/3.jpg') }}"></span> Nathan
                                </a>
                                <i class="fab fa-facebook text-primary" aria-hidden="true"></i>
                                <i class="fab fa-twitter text-primary" aria-hidden="true"></i>
                                <i class="fas fa-envelope text-primary" aria-hidden="true"></i>
                            ...
                            <div class="team">
                                <a href="javascript:void(0)" class="chip">
                                    <span class="avatar cover-image"
                                        data-image-src="{{ URL::asset('assets/img/faces/4.jpg') }}"></span> Alice
                                </a>
                                <i class="fab fa-facebook text-primary" aria-hidden="true"></i>
                                <i class="fab fa-twitter text-primary" aria-hidden="true"></i>
                                <i class="fas fa-envelope text-primary" aria-hidden="true"></i>
                                <p class="mb-0">On the other hand, we denounce with right indignation and dislike
                                    imagesralized</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <table class="table card-table country-table mb-0">
                        <tbody>
                            <tr>
                                <td class="w-1"><img src="{{ URL::asset('assets/img/flags/us_flag.jpg') }}"
                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                                <td>USA
                            ...
                            <tr>
                                <td class="w-1"><img src="{{ URL::asset('assets/img/flags/spain_flag.jpg') }}"
                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                                <td>Spain
                                    <div class="progress progress-sm mt-1">
                            ...
                            <tr>
                                <td class="w-1"><img src="{{ URL::asset('assets/img/flags/germany_flag.jpg') }}"
                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                                <td>Germany
                                    <div class="progress progress-sm mt-1">
                            ...
                            <tr>
                                <td class="w-1"><img src="{{ URL::asset('assets/img/flags/russia_flag.jpg') }}"
                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                                <td>Russia
                                    <div class="progress progress-sm mt-1">
                            ...
                            <tr>
                                <td class="w-1"><img src="{{ URL::asset('assets/img/flags/italy_flag.jpg') }}"
                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                                <td>Italy
                                    <div class="progress progress-sm mt-1">
                            ...
                            <tr>
                                <td class="w-1"><img src="{{ URL::asset('assets/img/flags/french_flag.jpg') }}"
                                        alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                                <td>French
                                    <div class="progress progress-sm mt-1">
                                        <div class="progress-bar bg-teal wd-40"></div>
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    ...
                    <p class="tx-12 tx-gray-500 mb-0">Opinion of a customer on the product in the form of ratings 5-star
                        rating. <a href="">Learn more</a></p>
                </div><!-- card-header -->
                <div class="card-body pd-y-7">
                    <div class="d-flex align-items-baseline">
                        <h1 class="tx-30 mg-b-5 mg-l-5">4.8</h1>
                        <p class="tx-11  mg-b-0"><span class="tx-medium tx-success">1.6% <i
                                    class="icon ion-md-arrow-up"></i></span></p>
                    </div>
                    <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-15">Overall product rating by
                        the customers.</h6>
                        ...
                        <tbody>
                                ...
                                <td class="w-100">
                                    <div class="progress mt-2 ht-5">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                                            class="progress-bar wd-20p bg-danger" role="progressbar"></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="w-100">
                                    <div class="progress mt-2 ht-5">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                                            class="progress-bar wd-30p bg-primary" role="progressbar"></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="w-100">
                                    <div class="progress mt-2 ht-5">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                                            class="progress-bar wd-60p bg-warning" role="progressbar"></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="w-100">
                                    <div class="progress mt-2 ht-5">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                                            class="progress-bar wd-70p bg-teal" role="progressbar"></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="w-100">
                                    <div class="progress mt-2 ht-5">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                                            class="progress-bar wd-80p bg-success" role="progressbar"></div>
                                    </div>
                                </td>
                    ...
                    <div class="wrapper d-flex justify-content-center image-group pb-3">
                        <img src="{{ URL::asset('assets/img/faces/1.jpg') }}" alt="profile"
                            class="img-xs rounded-circle">
                        <img src="{{ URL::asset('assets/img/faces/2.jpg') }}" alt="profile"
                            class="img-xs rounded-circle">
                        <img src="{{ URL::asset('assets/img/faces/13.jpg') }}" alt="profile"
                            class="img-xs rounded-circle">
                        <img src="{{ URL::asset('assets/img/faces/14.jpg') }}" alt="profile"
                            class="img-xs rounded-circle">
                        <img src="{{ URL::asset('assets/img/faces/5.jpg') }}" alt="profile"
                            class="img-xs rounded-circle">
                        <img src="{{ URL::asset('assets/img/faces/16.jpg') }}" alt="profile"
                            class="img-xs rounded-circle">
                    </div>
                </div><!-- card-body -->
            </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
            <div class="card order-list">
                <div class="card-body">
                    ...
                    <p class="tx-12 tx-gray-500 mb-3">Order Activity is ecommerce platforms to track the orders placed on
                        their stores <a href="">Learn more</a></p>
                    <ul class="list list-noborders pb-0 mb-0">
                        <li class="list-item">
                            ...
                            <div class="mr-auto d-flex">
                                <img class="img-sm ms-1" src="{{ URL::asset('assets/img/ecommerce/03.jpg') }}"
                                    alt="thumb images">
                                <img class="img-sm" src="{{ URL::asset('assets/img/ecommerce/08.jpg') }}"
                                    alt="thumb images">
                            </div>
                        </li>
                        <li class="list-item">
                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                src="{{ URL::asset('assets/img/faces/9.jpg') }}" alt="Profile Image">
                            <div class=" mr-3">
                                <h6 class="mb-1 font-weight-medium">Alan Macedo</h6>
                                <p class="mb-0 tx-13 text-muted">#PRD-10251</p>
                            </div>
                            <div class="mr-auto d-flex">
                                <img class="img-sm ms-1" src="{{ URL::asset('assets/img/ecommerce/04.jpg') }}"
                                    alt="thumb images">
                                <img class="img-sm" src="{{ URL::asset('assets/img/ecommerce/05.jpg') }}"
                                    alt="thumb images">
                            </div>
                        </li>
                        <li class="list-item">
                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                src="{{ URL::asset('assets/img/faces/5.jpg') }}" alt="Profile Image">
                            <div class=" mr-3">
                                <h6 class="mb-1 font-weight-medium">Bruce Tran</h6>
                                <p class="mb-0 text-muted tx-13">#PRD-10252</p>
                            </div>
                            <div class="mr-auto d-flex">
                                <img class="img-sm ms-1" src="{{ URL::asset('assets/img/ecommerce/06.jpg') }}"
                                    alt="thumb images">
                                <img class="img-sm" src="{{ URL::asset('assets/img/ecommerce/07.jpg') }}"
                                    alt="thumb images">
                            </div>
                        </li>
                        <li class="list-item">
                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                src="{{ URL::asset('assets/img/faces/12.jpg') }}" alt="Profile Image">
                            <div class=" mr-3">
                                <h6 class="mb-1 font-weight-medium">Mina Harper</h6>
                                <p class="mb-0 text-muted tx-13">#PRD-10253</p>
                            </div>
                            <div class="mr-auto d-flex">
                                <img class="img-sm ms-1" src="{{ URL::asset('assets/img/ecommerce/08.jpg') }}"
                                    alt="thumb images">
                                <img class="img-sm" src="{{ URL::asset('assets/img/ecommerce/09.jpg') }}"
                                    alt="thumb images">
                            </div>
                        </li>
                        <li class="list-item pb-0 mb-0">
                            <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
                                src="{{ URL::asset('assets/img/faces/8.jpg') }}" alt="Profile Image">
                            <div class=" mr-3">
                                <h6 class="mb-1 font-weight-medium">Maria Quinn</h6>
                                <p class="mb-0 text-muted tx-13">#PRD-10254</p>
                            </div>
                            <div class="mr-auto d-flex">
                                <img class="img-sm ms-1" src="{{ URL::asset('assets/img/ecommerce/02.jpg') }}"
                                    alt="thumb images">
                                <img class="img-sm" src="{{ URL::asset('assets/img/ecommerce/01.jpg') }}"
                                    alt="thumb images">
                            </div>
                        </li>
                    </ul>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4 col-sm-12">
            <div class="card">
                ...
                <p class="tx-12 tx-gray-500 mb-0 pl-3 pr-3">A review is an evaluation of a publication, service, or
                    ...
                    <div class="pl-3 pr-3 py-3 border-bottom">
                        <div class="media mt-0">
                            <div class="d-flex ms-3">
                                <a href="#">
                                    <img class="media-object avatar brround w-7 h-7" alt="64x64"
                    ...
                    <div class="pl-3 pr-3 py-3 border-bottom">
                        <div class="media mt-0">
                            <div class="d-flex ms-3">
                                <a href="#">
                                    <img class="media-object avatar brround w-7 h-7" alt="64x64"
                                        src="{{ URL::asset('assets/img/faces/9.jpg') }}">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="d-flex">
                    ...
                    <div class="pl-3 pr-3 py-3 border-bottom">
                        <div class="media mt-0">
                            <div class="d-flex ms-3">
                                <a href="#">
                                    <img class="media-object avatar brround w-7 h-7" alt="64x64"
                                        src="{{ URL::asset('assets/img/faces/4.jpg') }}">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="d-flex">
                    ...
                    <div class="pl-3 pr-3 py-3 border-bottom">
                        <div class="media mt-0">
                            <div class="d-flex ms-3">
                                <a href="#">
                                    <img class="media-object avatar brround w-7 h-7" alt="64x64"
                                        src="{{ URL::asset('assets/img/faces/7.jpg') }}">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="d-flex">
                    ...
                    <div class="pl-3 pr-3 py-3 border-bottom">
                        <div class="media mt-0">
                            <div class="d-flex ms-3">
                                <a href="#">
                                    <img class="media-object avatar brround w-7 h-7" alt="64x64"
                                        src="{{ URL::asset('assets/img/faces/13.jpg') }}">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="d-flex">
                    ...
                    <div class="pl-3 pr-3 py-3 border-bottom">
                        <div class="media mt-0">
                            <div class="d-flex ms-3">
                                <a href="#">
                                    <img class="media-object avatar brround w-7 h-7" alt="64x64"
                                        src="{{ URL::asset('assets/img/faces/2.jpg') }}">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="d-flex">
        ...
        <div class="col-md-12 col-lg-6  col-xl-4">
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    ...
                    <p class="tx-12 tx-gray-500 mb-0">session by country mean that the user is from the stated country or
                        that the session is originating in the stated country. <a href="">Learn more</a></p>
                </div>
                <div class="card-body">
                    <ul class="sales-session mb-0">
                        <li>
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="font-weight-semibold mb-2">$273.12 <span
                                        class="text-muted font-weight-normal">(2.17%)</span></p>
                            </div>
                            <div class="progress  ht-5">
                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
                                    class="progress-bar wd-60p bg-primary" role="progressbar"></div>
                            </div>
                        </li>
                        <li>
                            <div class="d-flex justify-content-between">
                                <h6>2. United kingdom</h6>
                                <p class="font-weight-semibold mb-2">$423.10 <span
                                        class="text-muted font-weight-normal">(12.43%)</span></p>
                            </div>
                            <div class="progress  ht-5">
                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
                                    class="progress-bar wd-70p bg-info" role="progressbar"></div>
                            </div>
                        </li>
                        <li>
                            <div class="d-flex justify-content-between">
                                <h6>3. Australia</h6>
                                <p class="font-weight-semibold mb-2">$547.18 <span
                                        class="text-muted font-weight-normal">(3.14%)</span></p>
                            </div>
                            <div class="progress  ht-5">
                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60"
                                    class="progress-bar wd-60p bg-danger" role="progressbar"></div>
                            </div>
                        </li>
                        <li>
                            <div class="d-flex justify-content-between">
                                <h6>4. Canada</h6>
                                <p class="font-weight-semibold mb-2">$728.32 <span
                                        class="text-muted font-weight-normal">(7.23%)</span></p>
                            </div>
                            <div class="progress  ht-5">
                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
                                    class="progress-bar wd-50p bg-warning" role="progressbar"></div>
                            </div>
                        </li>
                        <li>
                            <div class="d-flex justify-content-between">
                                <h6>5. Russia</h6>
                                <p class="font-weight-semibold mb-2">$843.19 <span
                                        class="text-muted font-weight-normal">(1.83%)</span></p>
                            </div>
                            <div class="progress mb-0 ht-5">
                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
                                    class="progress-bar wd-40p bg-success" role="progressbar"></div>
                            </div>
                        </li>
                        <li class="mb-0 pb-1">
                            <div class="d-flex justify-content-between">
                                <h6>6. Japan</h6>
                                <p class="font-weight-semibold mb-2">$562.19 <span
                                        class="text-muted font-weight-normal">(1.35%)</span></p>
                            </div>
                            <div class="progress mb-0 ht-5">
                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
                                    class="progress-bar wd-60p bg-purple" role="progressbar"></div>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4 col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="tx-12 tx-gray-500 mb-0">Tells you where your visitors originated from, such as search
                        engines, social networks or website referrals. <a href="">Learn more</a></p>
                </div><!-- card-header -->
                <div class="card-body p-0">
                    <div class="browser-stats">
                        <div class="d-flex align-items-center item  border-bottom">
                            <div class="d-flex">
                                <img src="{{ URL::asset('assets/img/svgicons/chrome.svg') }}" alt="img"
                                    class="ht-30 wd-30 ms-2">
                                <div class="">
                                    <h6 class="">Chrome</h6>
                            ...
                            <div class="mr-auto my-auto">
                                <div class="d-flex">
                                    <span class="ms-4 my-auto">35,502</span>
                        ...
                        <div class="d-flex align-items-center item  border-bottom">
                            <div class="d-flex">
                                <img src="{{ URL::asset('assets/img/svgicons/opera.svg') }}" alt="img"
                                    class="ht-30 wd-30 ms-2">
                                <div class="">
                                    <h6 class="">Opera</h6>
                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                            ...
                            <div class="mr-auto my-auto">
                                <div class="d-flex">
                                    <span class="ms-4 my-auto">12,563</span>
                        ...
                        <div class="d-flex align-items-center item  border-bottom">
                            <div class="d-flex">
                                <img src="{{ URL::asset('assets/img/svgicons/edge.svg') }}" alt="img"
                                    class="ht-30 wd-30 ms-2">
                                <div class="">
                                    <h6 class="">Edge</h6>
                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                            ...
                            <div class="mr-auto my-auto">
                                <div class="d-flex">
                                    <span class="ms-4 mt-1">25,364</span>
                        ...
                        <div class="d-flex align-items-center item  border-bottom">
                            <div class="d-flex">
                                <img src="{{ URL::asset('assets/img/svgicons/firefox.svg') }}" alt="img"
                                    class="ht-30 wd-30 ms-2">
                                <div class="">
                                    <h6 class="">Firefox</h6>
                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                            ...
                            <div class="mr-auto my-auto">
                                <div class="d-flex">
                                    <span class="ms-4 mt-1">14,635</span>
                        ...
                        <div class="d-flex align-items-center item border-bottom">
                            <div class="d-flex">
                                <img src="{{ URL::asset('assets/img/svgicons/uc-browser.svg') }}" alt="img"
                                    class="ht-30 wd-30 ms-2">
                                <div class="">
                            ...
                            <div class="mr-auto my-auto">
                                <div class="d-flex">
                                    <span class="ms-4 mt-1">15,453</span>
                        ...
                        <div class="d-flex align-items-center item">
                            <div class="d-flex">
                                <img src="{{ URL::asset('assets/img/svgicons/safari.svg') }}" alt="img"
                                    class="ht-30 wd-30 ms-2">
                                <div class="">
                                    <h6 class="">Safari</h6>
                                    <span class="sub-text">Mozilla Foundation, Inc.</span>
                            ...
                            <div class="mr-auto my-auto">
                                <div class="d-flex">
                                    <span class="ms-4 mt-1">35,657</span>
