...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="pagination1">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><ul class="pagination">
	...
	<li class="page-item"><a class="page-link" href="#"><i class="icon ion-ios-arrow-back"></i></a></li>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#pagination1"><i
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="pagination2">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="pd-20 bg-gray-800">
	<ul class="pagination pagination-dark mg-b-0">
		...
		<li class="page-item"><a class="page-link" href="#"><i class="icon ion-ios-arrow-back"></i></a></li>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#pagination2"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="pagination3">
	...
	<div class="col-sm-6 col-lg-4 mg-sm-t-0">
		<ul class="pagination pagination-success">
			...
			<li class="page-item"><a class="page-link" href="#"><i class="icon ion-ios-arrow-back"></i></a></li>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#pagination3"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="pagination4">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><ul class="pagination pagination-circled mb-0">
	<li class="page-item"><a class="page-link" href="#"><i class="icon ion-ios-arrow-forward"></i></a></li>
	<li class="page-item active"><a class="page-link" href="#">1</a></li>
	<li class="page-item"><a class="page-link" href="#">2</a></li>
	<li class="page-item"><a class="page-link" href="#">3</a></li>
	<li class="page-item"><a class="page-link" href="#"><i class="icon ion-ios-arrow-back"></i></a></li>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#pagination4"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
