...
@section('content')
            ...
            <div class="card custom-card" id="sizes">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">An avatar can have different sizes like larger and smaller
                            avatar.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code1" data-toggle="tab"
                                    href="#htms-code1" role="tab" aria-controls="htms-code1" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar1">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="demo-avatar-group">
	<div class="main-img-user avatar-xs">
	...
	<div class="main-img-user avatar-xxl d-none d-sm-block">
		<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/faces/8.jpg')}}">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#avatar1"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="shapes">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">An avatar can have different shapes like square and round,
                            radius avatars.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar2">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="demo-avatar-group">
	<div class="main-img-user avatar-md">
		<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/faces/4.jpg')}}">
	</div>
	...
	<div class="main-img-user avatar-md">
		<img alt="avatar" class="radius" src="{{URL::asset('assets/img/faces/6.jpg')}}">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#avatar2"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="initials">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">An avatar can have a temporary use of user's initial name
                            while their photos are not yet available.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar3">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="demo-avatar-group avatar-list">
	<div class="avatar avatar-xs bg-primary rounded-circle">
		A
	</div>
	<div class="avatar avatar-sm bg-secondary rounded-circle">
	...
	<div class="avatar avatar-xxl d-none d-sm-flex bg-pink rounded-circle">
		NB
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#avatar3"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="status">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">An avatar can have a status indicator to indicate users
                            availability.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar4">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="demo-avatar-group">
	<div class="main-avatar avatar online">
	...
	<div class="main-avatar avatar-md offline">
		eb
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#avatar4"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
