...
@section('content')
            ...
            <div class="card" id="popover">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Documentation and examples for adding Bootstrap popovers, like
                            those found in iOS, to any element on your site..</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                                ...
                                <div class="row row-sm tx-center">
                                    <div class="col-sm-6 col-lg-3">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            ...
                                            data-original-title="Popover top">Click me</button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-sm-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-toggle="popover" data-popover-color="default" data-placement="bottom"
                                            title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover bottom">Click me</button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-lg-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-toggle="popover" data-popover-color="default" data-placement="left"
                                            title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover left">Click me</button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-lg-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-toggle="popover" data-popover-color="default" data-placement="right"
                                            title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover right">Click me</button>
                                    </div><!-- col-3 -->
                                </div><!-- row -->
                            </div>
                        </div>
                        <ul class="nav nav-tabs htms-source" id="htms-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code" data-toggle="tab"
                                    href="#htms-code" role="tab" aria-controls="htms-code" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="popover01">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-sm tx-center">
	<div class="col-sm-6 col-lg-3">
	...
	<div class="col-sm-6 col-lg-3 mg-t-30 mg-lg-t-0">
		<button type="button" class="btn btn-secondary" data-container="body" data-toggle="popover" data-popover-color="default" data-placement="right" title="" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Popover right">Click me</button>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#popover01"><i
            ...
            <div class="card" id="popover2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <div class="example border-top-0">
                            <div class="pd-20 bg-gray-200">
                                <div class="row row-sm tx-center">
                                    <div class="col-sm-6 col-lg-3">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-popover-color="head-primary" data-placement="top" title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover top">Click me</button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-sm-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-popover-color="head-secondary" data-placement="bottom" title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover bottom">Click me</button>
                                    </div><!-- col-3 -->
                                </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="popover02">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-sm tx-center">
		<div class="col-sm-6 col-lg-3">
		...
		<div class="col-sm-6 col-lg-3 mg-t-30 mg-sm-t-0">
			<button type="button" class="btn btn-secondary" data-container="body" data-popover-color="head-secondary" data-placement="bottom" title="" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Popover bottom">Click me</button>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#popover02"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card" id="popover3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <div class="example border-top-0">
                            <div class="pd-20 bg-gray-200">
                                <div class="row row-sm tx-center">
                                    <div class="col-sm-6 col-lg-3">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-popover-color="primary" data-placement="top" title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover top">Click me</button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-sm-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                            data-popover-color="secondary" data-placement="bottom" title=""
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                            data-original-title="Popover bottom">Click me</button>
                                    </div><!-- col-3 -->
                                </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="popover03">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row row-sm tx-center">
	<div class="col-sm-6 col-lg-3">
	...
	<div class="col-sm-6 col-lg-3 mg-t-30 mg-sm-t-0">
		<button type="button" class="btn btn-secondary" data-container="body" data-popover-color="secondary" data-placement="bottom" title="" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Popover bottom">Click me</button>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#popover03"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
