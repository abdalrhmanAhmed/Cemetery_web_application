                        ...
                        <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label text-muted d-flex">
                                            <div class="dot-label bg-gray-300 ms-1"></div>Inactive
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label text-success d-flex">
                                            <div class="dot-label bg-success ms-1"></div>Active
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label text-danger d-flex">
                                            <div class="dot-label bg-danger ms-1"></div> Banned
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label text-warning d-flex">
                                            <div class="dot-label bg-warning ms-1"></div>Pending
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img alt="avatar" class="rounded-circle avatar-md mr-2"
                                            src="{{ URL::asset('assets/img/faces/17.jpg') }}">
                                    </td>
                                    <td>Paul Molive</td>
                                    <td>
                                        12/07/2020
