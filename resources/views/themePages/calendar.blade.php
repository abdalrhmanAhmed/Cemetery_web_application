...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Apps</h4><span class="text-muted mt-1 tx-13 me-2 mb-0">/
                    Calendar</span>
            </div>
        </div>
                ...
                <div class=" card card--calendar p-0 mg-b-20">
                    <div class="p-4 border-bottom">
                        ...
                        <div class="text-center mx-auto">
                            <img src="{{ URL::asset('assets/img/media/calendar.png') }}" alt="calendar"
                                class="ht-80p wd-80p">
                        </div>
                    </div>
                    ...
                    <div class="p-4 pt-0">
                        ...
                        <nav class="nav main-nav-column main-nav-calendar-event">
                            ...
                            </a> <a class="nav-link" href=""><i class="icon ion-ios-calendar tx-success"></i>
                                <div>
                                    Birthday Events
                                </div>
                            </a> <a class="nav-link" href=""><i class="icon ion-ios-calendar tx-danger"></i>
                                <div>
                                    Holiday Calendar
                                </div>
                            </a> <a class="nav-link" href=""><i class="icon ion-ios-calendar tx-warning"></i>
                                <div>
                                    Other Calendar
                                </div>
                            </a> <a class="nav-link exclude" href=""><i class="icon ion-ios-calendar tx-info"></i>
                                <div>
                                    Discovered Events
                                </div>
                            </a>
