...
@section('content')
            ...
            <div class="card custom-card" id="thumb">
                <div class="card-body ht-100p">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Images in Bootstrap are made responsive with .img-fluid.
                            max-width: 100%; and height: auto; are applied to the image so that it scales with the parent
                            element.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <figure class="highlight clip-widget" id="images2">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="row">
	<div class="col-6 col-md-3">
	...
	<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
		<img alt="Responsive image" class="img-thumbnail" src="{{URL::asset('assets/img/photos/15.jpg')}}">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#images2"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="aligning">
                <div class="card-body ht-100p">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Align images with the helper float classes or text alignment
                            classes.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                            <div class="clearfix">
                                <img src="{{ URL::asset('assets/img/photos/10.jpg') }}"
                                    class="float-sm-left wd-100p wd-sm-200" alt="img">
                                <img src="{{ URL::asset('assets/img/photos/11.jpg') }}"
                        ...
                        <figure class="highlight clip-widget" id="images3">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="clearfix">
  ...
  <img src="{{URL::asset('assets/img/photos/11.jpg')}}" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" alt="img">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#images3"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4">
                                    <div class="img-thumbnail mb-3">
                                        <a href="#">
                                            <img src="{{ URL::asset('assets/img/photos/4.jpg') }}" alt="thumb1"
                                ...
                                <div class="col-xl-4 col-lg-4">
                                    <div class="img-thumbnail mb-3">
                                        <a href="#">
                                            <img src="{{ URL::asset('assets/img/photos/9.jpg') }}" alt="thumb1"
                                                class="thumbimg  wd-100p">
                                        </a>
                                        <div class="caption">
                                            <h5>Thumbnail label</h5>
                                ...
                                <div class="col-xl-4 col-lg-4">
                                    <div class="img-thumbnail mb-3">
                                        <a href="#">
                                            <img src="{{ URL::asset('assets/img/photos/8.jpg') }}" alt="thumb1"
                                                class="thumbimg  wd-100p">
                                        </a>
                                        <div class="caption">
                                            <h5>Thumbnail label</h5>
			...
			<div class="caption">
				...
				<div class="btn btn-list pl-0 pb-0">
					...
					<a href="#" class="btn ripple btn-secondary" role="button">Button</a>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#images5"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div><img alt="Responsive image" class="img-fluid"
                                    src="{{ URL::asset('assets/img/photos/7.jpg') }}"></div>
                        </div>
                        ...
                        <figure class="highlight clip-widget" id="images1">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('assets/img/media/7.jpg')}}"></div>
</script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#images1"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="background">
                <div class="card-body ht-100p">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Make image as background to your content using the helper or
                            utilities classes.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                            <figure class="pos-relative mg-b-0">
                                ...
                                <figcaption class="pos-absolute a-0 pd-25 bg-black-5 tx-white-8">
                                    ...
                                    <p class="mg-b-0">Royalty free means you just need to pay for rights to use the item
                                        once per end product.
                                        You dont need to pay additional or ongoing fees for each person who sees or uses it.
                                    </p>
                                </figcaption>
                            </figure>
                        </div>
                        ...
                        <figure class="highlight clip-widget" id="images4">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><figure class="pos-relative mg-b-0">
...
to use the item once per end product. You dont need to pay additional or ongoing fees for each person who sees or uses it.</p>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#images4"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
