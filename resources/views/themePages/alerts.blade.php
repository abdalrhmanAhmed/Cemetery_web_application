...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Elements</h4><span class="text-muted mt-1 tx-13 me-2 mb-0">/
                    Alerts</span>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code" data-toggle="tab" href="#htms-code"
                                    role="tab" aria-controls="htms-code" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Code -->
                        <figure class="highlight clip-widget" id="alert1">
                            <pre><code class="language-markup"><script type="htms-dashlead/script">
<div class="alert alert-success" role="alert">
    <button aria-label="Close" class="close" data-bs-dismiss="alert" type="button">
	   <span aria-hidden="true">&times;</span>
  </button>
...
<div class="alert alert-danger mg-b-0" role="alert">
	...
	<strong>Oh snap!</strong> Change a few things up and try submitting again.
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert1"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code2" data-toggle="tab"
                                    href="#htms-code2" role="tab" aria-controls="htms-code2" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Code -->
                        <figure class="highlight clip-widget" id="alert001">
                            <pre><code class="language-markup"><script type="htms-dashlead/script">
<div class="alert alert-outline-success" role="alert">
	<button aria-label="Close" class="close" data-bs-dismiss="alert" type="button">
	<span aria-hidden="true">&times;</span></button>
...
<div class="alert alert-outline-danger mg-b-0" role="alert">
	...
	<strong>Oh snap!</strong> Change a few things up and try submitting again.
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert001"><i
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code3" data-toggle="tab"
                                    href="#htms-code3" role="tab" aria-controls="htms-code3" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <figure class="highlight clip-widget" id="alert2">
                            <pre><code class="language-markup"><script type="htms-dashlead/script">
<div class="alert alert-solid-success" role="alert">
	<button aria-label="Close" class="close" data-bs-dismiss="alert" type="button">
	<span aria-hidden="true">&times;</span></button>
...
<div class="alert alert-solid-danger mg-b-0" role="alert">
	...
	<strong>Oh snap!</strong> Change a few things up and try submitting again.
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert2"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="link-alerts">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Use the <code class="highlighter-rouge">.alert-link</code>
                            utility class to quickly provide matching colored links within any alert.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                            ...
                            <div class="alert alert-danger" role="alert">
                                This is a danger alert with <a href="#" class="alert-link">an example link</a>. Give
                            ...
                            <div class="alert alert-light" role="alert">
                                This is a light alert with <a href="#" class="alert-link">an example link</a>. Give
                                it a click if you like.
                            </div>
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code4" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code4" data-toggle="tab"
                                    href="#htms-code4" role="tab" aria-controls="htms-code4" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>

                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="alert4">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="alert alert-primary" role="alert">
...
<div class="alert alert-dark mb-0" role="alert">
  This is a dark alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert4"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="additional-alerts">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Alerts can also contain additional HTML elements like
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code5" data-toggle="tab"
                                    href="#htms-code5" role="tab" aria-controls="htms-code5" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="alert5">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="alert alert-success mb-0" role="alert">
  <h4 class="alert-heading">Well done!</h4>
  ...
  <p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert5"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="dismiss-alerts">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Using the alert JavaScript plugin, it’s possible to dismiss
                            any alert inline.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code6" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code6" data-toggle="tab"
                                    href="#htms-code6" role="tab" aria-controls="htms-code" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="alert6">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Holy guacamole!</strong> You should check in on some of those fields below.
  <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
  </button>
...
<div class="alert alert-info alert-dismissible fade show mb-0" role="alert">
  ...
  <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert6"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code7" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code7" data-toggle="tab"
                                    href="#htms-code7" role="tab" aria-controls="htms-code7" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="alert7">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="alert alert-default" role="alert">
	<span class="alert-inner--icon"><i class="fe fe-download"></i></span>
...
<div class="alert alert-danger mb-0" role="alert">
	...
	<span class="alert-inner--text"><strong>Danger!</strong> This is a warning alert—check it out that has an icon too!</span>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert7"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="alert alert-default alert-dismissible fade show" role="alert">
                                <span class="alert-inner--icon"><i class="fe fe-download"></i></span>
                                <span class="alert-inner--text"><strong>Default!</strong> This is a default alert—check it
                                    out!</span>
                                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                            ...
                            <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                <span class="alert-inner--icon"><i class="fe fe-check-square"></i></span>
                                <span class="alert-inner--text"><strong>Primary!</strong> This is a primary alert—check it
                                    out!</span>
                                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <span class="alert-inner--icon"><i class="fe fe-thumbs-up"></i></span>
                                <span class="alert-inner--text"><strong>Success!</strong> This is a success alert—check it
                                    out!</span>
                                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            ...
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <span class="alert-inner--icon"><i class="ti-bell"></i></span>
                                <span class="alert-inner--text"><strong>Info!</strong> This is a info alert—check it
                                    out!</span>
                                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            ...
                            <div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
                                <span class="alert-inner--icon"><i class="fe fe-slash"></i></span>
                                <span class="alert-inner--text"><strong>Danger!</strong> This is a danger alert—check it
                                    out!</span>
                                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code8" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code8" data-toggle="tab"
                                    href="#htms-code8" role="tab" aria-controls="htms-code" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="alert8">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="alert alert-default alert-dismissible fade show" role="alert">
	<span class="alert-inner--icon"><i class="fe fe-download"></i></span>
...
<div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
	...
	<button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">×</span>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert8"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
