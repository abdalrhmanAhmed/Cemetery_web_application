...
@section('content')
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card mg-b-20" id="list">
                <div class="card-body">
                    ...
                    <p class="mg-b-20 text-muted card-sub-title">It is Very Easy to Customize and it uses in your website
                        apllication</p>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list01">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="listgroup-example ">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
		...
		<li>Vestibulum at eros</li>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#list01"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
            ...
            <div class="card mg-b-20" id="list1">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list02">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="listgroup-example2">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
		...
		<li>Vestibulum at eros</li>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#list02"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
                        ...
                        <div class="example">
                            <div class="list-group">
                                <a class="list-group-item list-group-item-action flex-column align-items-start active"
                                    href="#">
                                    <span class="d-flex">
                                        <img alt="" class="ms-3 rounded-circle avatar-md"
                                        ...
                                        <div class="">
                                            ...
                                            <p class="mb-1 tx-13">Donec id elit non mi porta gravida at eget metus.
                                                Maecenas sed diam eget risus varius blandit.</p><small>Donec id elit non mi
                                                porta.</small>
                                        </div>
                                    </span>
                                </a>
            ...
            <div class="card mg-b-20" id="list3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                                ...
                                <div class="list-group-item pd-y-20">
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ms-4 rounded-circle avatar-md"
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="tx-13 mg-b-10 text-muted mb-0">Lorem Ipsum is simply dummy text of
                                                the printing and typesetting industry. Lorem Ipsum has been the industries .
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list03">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><div class="list-group">
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-l-10 wd-50">
				<img class="ms-4 rounded-circle avatar-md" src="{{URL::asset('assets/img/faces/17.jpg')}}" alt="avatar">
			</div>
			<div class="media-body">
				<div class="media-body d-flex">
					<h6 class="tx-15 mb-2">Blake Vanessa</h6>
	...
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-l-10 wd-50">
				<img class="ms-4 rounded-circle avatar-md" src="{{URL::asset('assets/img/faces/5.jpg')}}" alt="avatar">
			</div>
			<div class="media-body">
				<div class="media-body d-flex">
					<h6 class="tx-15 mb-2">Elizabeth Parsons</h6>
	...
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-r-10 wd-50">
				<img class="ms-4 rounded-circle avatar-md" src="{{URL::asset('assets/img/faces/12.jpg')}}" alt="avatar">
			</div>
			<div class="media-body">
				<div class="media-body d-flex">
					<h6 class="tx-15 mb-2">Nicola Lambert</h6>
				...
				<p class="tx-13 mg-b-10 text-muted mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industries .</p>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#list03"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
                            ...
                            <ul class="list-group wd-md-100p users-list-group">
                                <li class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="d-flex float-right mr-auto">
                                        <a href="#" class="btn btn-outline-light btn-icon ms-2">
                        ...
                        <ul class="nav nav-tabs htms-source" id="htms-source-code8" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ms-1 htms-code" id="htms-code8" data-toggle="tab"
                                    href="#htms-code8" role="tab" aria-controls="htms-code8" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ms-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list08">
                            <pre><code class="language-markup"><script type="htms-dashlead/script"><ul class="list-group wd-md-100p users-list-group">
	<li class="list-group-item d-flex align-items-center">
		<img alt="" class="ms-3 rounded-circle avatar-md" src="{{URL::asset('assets/img/faces/5.jpg')}}">
		<div>
	...
	<li class="list-group-item d-flex align-items-center">
		<img alt="" class="ms-3 rounded-circle avatar-md" src="{{URL::asset('assets/img/faces/6.jpg')}}">
		<div>
	...
	<li class="list-group-item d-flex align-items-center">
		<img alt="" class="ms-3 rounded-circle avatar-md" src="{{URL::asset('assets/img/faces/12.jpg')}}">
		<div>
		...
		<div class="d-flex float-right mr-auto">
			...
			<a href="#" class="btn btn-outline-light btn-icon">
			  <div class=""><i class="bx bx-minus"></i></div>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#list08"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
