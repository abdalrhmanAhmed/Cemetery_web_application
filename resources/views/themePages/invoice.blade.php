                ...
                <div class="card card-invoice">
                    <div class="card-body">
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-12">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                    ...
                                    <tr>
                                        <td>Android App</td>
                                        <td class="tx-12">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet,
                        ...
                        <a class="btn btn-purple float-left mt-3 mr-2" href="">
                            <i class="mdi mdi-currency-usd ms-1"></i>Pay Now
                        </a>
                        <a href="#" class="btn btn-danger float-left mt-3 mr-2">
                            <i class="mdi mdi-printer ms-1"></i>Print
                        </a>
                        <a href="#" class="btn btn-success float-left mt-3">
                            <i class="mdi mdi-telegram ms-1"></i>Send Invoice
                        </a>
                    </div>
                </div>
            </div>
