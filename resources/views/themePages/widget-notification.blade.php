            ...
            <div class="card bd-0 mg-b-20">
                <div class="card-body bd bd-success text-success text-center">
                    <div class="success-widget">
                        <h3>Success!</h3>
                        <p class="mt-3 mb-0">Thanks so much for your message. We check e-mail frequently and will try our
                            best to respond to your inquiry.</p>
                    </div>
                </div>
            </div>
            <!--Page Widget Error-->
