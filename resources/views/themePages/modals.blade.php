        ...
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-info" data-bs-target="#modaldemo3" data-bs-toggle="modal" href="">View
                        Demo</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-primary" data-bs-target="#scrollingmodal" data-bs-toggle="modal"
                        href="">View Demo</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20">
                            <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-just-me"
                                data-bs-toggle="modal" href="#modaldemo8">Just Me</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    ...
                    <p class="mg-b-20 mg-x-20">There are many variations of passages of Lorem Ipsum available, but the
                        ...
                        class="btn ripple btn-success pd-x-25" data-bs-dismiss="modal" type="button">Continue</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    ...
                    <p class="mg-b-20 mg-x-20">There are many variations of passages of Lorem Ipsum available, but the
                        majority have suffered alteration.</p><button aria-label="Close"
                        class="btn ripple btn-danger pd-x-25" data-bs-dismiss="modal" type="button">Continue</button>
                </div>
            </div>
        </div>
    </div>
