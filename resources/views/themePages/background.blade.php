...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Utilities</h4><span class="text-muted mt-1 tx-13 me-2 mb-0">/
                    Background</span>
            </div>
        </div>
                    ...
                    <div class="table-responsive mg-t-20 mb-0">
                        <table class="table main-table-reference text-nowrap mg-t-0 mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td class="bg-gray-100 wd-20p"><b>Values</b></td>
                                    <td>primary | secondary | success | warning | danger | info | indigo | purple | pink |
                                        teal | orange</td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>primary-gradient | secondary-gradient | success-gradient | warning-gradient |
                                        dange-gradientr | info-gradient | purple-gradient | pink-gradient | teal-gradient
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="flex-1 pos-relative">
                            <img alt="" class="wd-100p ht-100p object-fit-cover"
