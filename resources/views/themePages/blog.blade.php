    ...
    <div class="row">
        <div class="col-xl-4 col-md-4">
            <div class="card custom-card">
                <img class="card-img-top w-100 bg-danger-transparent"
                    src="{{ URL::asset('assets/img/media/illustrate.png') }}" alt="">
                <div class="card-body">
                    <h4 class="card-title">Blog Title</h4>
                    <p class="card-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                        doloremque laudantium, totam rem aperiam, eaque ipsa. </p>
                    <a class="" href="#">Read More<i class="fe fe-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-md-4">
            <div class="card custom-card">
                <img class="card-img-top w-100 bg-success-transparent"
                    src="{{ URL::asset('assets/img/media/illustrate1.png') }}" alt="">
                <div class="card-body">
                    <h4 class="card-title">Blog Title</h4>
                    <p class="card-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                        doloremque laudantium, totam rem aperiam, eaque ipsa. </p>
        ...
        <div class="col-xl-4 col-md-4">
            <div class="card custom-card">
                <img class="card-img-top w-100 bg-warning-transparent" src="{{ URL::asset('assets/img/media/image2.png') }}"
                    alt="">
                <div class="card-body">
                    <h4 class="card-title">Blog Title</h4>
                    <p class="card-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
        ...
        <div class="col-xl-4 col-md-4">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                        doloremque laudantium, totam rem aperiam, eaque ipsa. </p>
                    <a class="btn ripple btn-primary" href="#">Read More<i class="fe fe-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-md-4">
        ...
        <div class="col-xl-3 col-lg-6  col-sm-6">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                        deserunt mollit anim id est laborum.</p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card card-aside custom-card">
                <a href="#" class="card-aside-column  cover-image"
                    data-image-src="{{ URL::asset('assets/img/photos/11.jpg') }}"
                    style="background: url(&quot;{{ URL::asset('assets/img/photos/11.jpg') }}&quot;) center center;"></a>
                <div class="card-body d-flex flex-column">
                    <h4><a href="#" class="card-title">Blog Title</a></h4>
                    <div class="">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                        mollit anim id est laborum.</div>
                    <div class="d-flex align-items-center pt-3 mt-auto">
                        <div class="main-img-user avatar-sm ms-3">
                            <img src="{{ URL::asset('assets/img/faces//1.jpg') }}" class="w-10 rounded-circle"
                                alt="avatar-img">
                        </div>
                        <div>
        ...
        <div class="col-lg-6">
            <div class="card card-aside custom-card">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center pt-3 mt-auto">
                        <div class="main-img-user avatar-sm ms-3">
                            <img src="{{ URL::asset('assets/img/faces//2.jpg') }}" class="w-10 rounded-circle"
                                alt="avatar-img">
                        </div>
                        <div>
                            <a href="" class="text-default">Alica Nestle</a>
                ...
                <a href="#" class="card-aside-column  cover-image"
                    data-image-src="{{ URL::asset('assets/img/photos/13.jpg') }}"
                    style="background: url(&quot;{{ URL::asset('assets/img/photos/13.jpg') }}&quot;) center center;"></a>
            </div>
        </div>
    </div>
    <!-- row closed -->
