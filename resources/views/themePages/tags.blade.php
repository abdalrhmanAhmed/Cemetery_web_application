...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element01">
                            <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="tags">
	<span class="tag">First tag</span>
	<span class="tag">Second tag</span>
	<span class="tag">Third tag</span>
</script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#element01"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element02">
                            <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="tags">
	<span class="tag tag-rounded">First tag</span>
	<span class="tag tag-rounded">Second tag</span>
	<span class="tag tag-rounded">Third tag</span>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element02"><i
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element03">
                            <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="tags">
	<span class="tag tag-default">
		One
		<a href="javascript:void(0)" class="tag-addon"><i class="fe fe-x"></i></a>
	...
	<span class="tag tag-default">
		...
		<a href="javascript:void(0)" class="tag-addon"><i class="fe fe-x"></i></a>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element03"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element04">
                            <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><div class="tags">
	<span class="tag tag-blue">Blue tag</span>
	<span class="tag tag-azure">Azure tag</span>
	<span class="tag tag-indigo">Indigo tag</span>
	...
	<span class="tag tag-gray-dark">Dark gray tag</span>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element04"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element05">
                            <pre><code class="language-markup mb-0"><script type="prismsmix/javascript"><select multiple data-role="tagsinput" class="form-control">
	<option value="jQuery">jQuery</option>
	<option value="Angular">Angular</option>
	<option value="React">React</option>
	<option value="Vue">Vue</option>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element05"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
